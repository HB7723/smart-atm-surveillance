...
DIAL_NUMBERS = ["+918470066183"]

TWIML_INSTRUCTIONS_URL = \
    "http://static.fullstackpython.com/phone-calls-python.xml"

# client = Client("AC00d044ca066af4a16ee9b3d296846ca1", "89c56a412a4b18591d4e6ebbffda08db")
client = Client("AC660496e4caad6cc5a25f4c04e5acf4f6",
                "b4c9e2a66a2586c223eeeda2f96b2df6")
danger = 1
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate(
            "MainWindow",
            "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; text-decoration: underline;\">SAFE</span></p></body></html>"))
        ...
        self.label_4.setText(_translate(
            "MainWindow",
            "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; text-decoration: underline;\">SECURITY AIDER</span></p></body></html>"))
        self.label_5.setText(_translate(
            "MainWindow",
            "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; text-decoration: underline; color:#ff0000;\">EMERGENCY SERVICES</span></p></body></html>"))
        ...
        self.pushButton_8.setText(_translate(
            "MainWindow", "CALL FIRE DEPARTMENT"))
        self.pushButton_9.setText(_translate(
            "MainWindow", "CALL LOCAL SECURITY"))
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.pushButton_7.clicked.connect(self.call_police)
        self.pushButton_8.clicked.connect(self.call_police)
        self.pushButton_9.clicked.connect(self.call_police)
    ...
    def dial_numbers(self, numbers_list):
        ...
        for number in numbers_list:
            ...
            try:
                ...
                print(f"Call made to {number} successfully")
    ...
    def next_slot(self):
        ...
        print("Page Switching -- To Call Interface")
    ...
    def call_police(self):
        ...
        #     self.dial_numbers(DIAL_NUMBERS)
        # except:
        #     print("Calling Security Services!!")

    def call_securiy(self):
        global DIAL_NUMBERS
        print("Calling Bank Security...")
